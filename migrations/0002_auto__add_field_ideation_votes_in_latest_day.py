...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ideation.votes_in_latest_day'
        db.add_column(u'quirktonomicon_ideation', 'votes_in_latest_day',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ideation.votes_in_latest_day'
        db.delete_column(u'quirktonomicon_ideation', 'votes_in_latest_day')
